...
shell_exec("cd $pantheon_site_workspace_folder && git submodule add " . $PANTHEON_CODESPACES_URL . " .devcontainer && cd .devcontainer && git checkout main && cd .. && git add .devcontainer && git commit -m \"Adding pantheon-codespaces submodule\" && git push github");